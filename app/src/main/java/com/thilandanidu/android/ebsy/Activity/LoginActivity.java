...
import com.thilandanidu.android.ebsy.Activity.Customer.CustomerHomeActivity;
import com.thilandanidu.android.ebsy.Activity.Customer.CustomerRegisterActivity;
import com.thilandanidu.android.ebsy.Activity.Seller.SellerHomeActivity;
import com.thilandanidu.android.ebsy.Activity.Seller.SellerRegisterActivity;
import com.thilandanidu.android.ebsy.Common.CommonFunction;
...
import com.thilandanidu.android.ebsy.Model.login;
...
import static com.thilandanidu.android.ebsy.Common.CommonFunction.CustomTost;
...
/*
    ...
    private void userLogin() {
        ...
        if (CommonFunction.checkNetworkConnection(LoginActivity.this)) {
            ...
            new SweetAlertDialog(LoginActivity.this, SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("No Internet Connection")
                    .setContentText("Please turn on Mobile data or connect to Wifi to proceed!")
                    .show();
